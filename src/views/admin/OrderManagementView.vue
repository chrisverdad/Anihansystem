          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="order in paginatedOrders" :key="order.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm font-medium text-gray-900">{{ vendorLabel(order.product) }}</div>
                  <div class="text-sm text-gray-500">{{ order.product?.vendor?.email || '—' }}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
            ...
            <div class="border-t pt-4">
              ...
              <div class="flex items-center space-x-4">
                ...
                <div class="flex-1">
                  ...
                  <p v-if="vendorLabel(selectedOrder.product) !== '—'" class="text-xs text-primary-700 mt-0.5">
                    Vendor: {{ vendorLabel(selectedOrder.product) }}
                  </p>
...
const vendorLabel = (product?: Product | null) => {
