      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-gray-600 mt-1">All vendor fulfillments; internal admin notes are not visible to vendors.</p>
          </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="delivery in paginatedDeliveries" :key="delivery.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 text-sm text-gray-600 max-w-xs truncate" :title="delivery.admin_notes || ''">
      ...
      <div class="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-md bg-white">
        <div class="mt-3">
          ...
          <div class="space-y-4">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Notes (shared)</label>
              <textarea
                v-model="deliveryForm.notes"
                rows="3"
                placeholder="Notes visible to vendor and operations"
                class="form-input"
              ></textarea>
            </div>

            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Admin-only notes</label>
              <textarea
                v-model="deliveryForm.admin_notes"
                rows="2"
  ...
  try {
    await productsStore.updateDeliveryStatus(
      ...
      deliveryForm.value.delivery_vehicle,
      {
        ...
        adminNotes: deliveryForm.value.admin_notes
      }
    )
    deliveries.value = productsStore.deliveries
